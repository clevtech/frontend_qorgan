...
import { TransportCreate, TransportRead } from '@/types/custom';
...
export const UpdateTransportModal = ({ transport: transportIn, isOpen, fetchDataSource, onClose }: Props) => {
    const [transport, setTransport] = useState<TransportCreate>({ plate: '', model: '', organization: '' });
    ...
    const handleUpdate = async () => {
        ...
        await TransportService.updateTransportById(
            {
                path: {
                    _id: transportIn._id,
                },
            ...
            .then(() => {
                notification.success({
                    message: 'Успешно',
                    description: 'Транспорт успешно отредактирован',
                });
            })
            .finally(() => {
                setIsLoading(false);
                ...
                <div className='d-flex flex-column' style={{ gap: '0.5rem' }}>
                    ...
                    <Form.Item
                        ...
                        rules={[
                            {
                                required: true,
                                message: 'Заполните марку организации',
                            },
                        ]}
                    >
